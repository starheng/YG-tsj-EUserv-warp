...
```
wget -qO- https://cdn.jsdelivr.net/gh/starheng/YG-tsj-EUserv-warp/warp4.sh|bash
```
#### 脚本2：IPV4与IPV6都是WARP分配的IP
```
wget -qO- https://cdn.jsdelivr.net/gh/starheng/YG-tsj-EUserv-warp/warp64.sh|bash
```
----------------------------------------------------------------------------------------------------
